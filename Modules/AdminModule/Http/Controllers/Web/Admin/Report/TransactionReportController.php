...
class TransactionReportController extends Controller
{
    ...
    {
        $blogs=Blog::all();
        return view('adminmodule::admin.report.blogs.index', compact('blogs'));
    }

    public function create()
    {
        return view('adminmodule::admin.report.blogs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $blog = new Blog([
            ...
            'image' =>  file_uploader('provider/logo/', 'png', $request->file('image')),
