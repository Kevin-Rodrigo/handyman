...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin'], function () {
    ...
    Route::group(['prefix' => 'blog', 'as' => 'blog.', 'namespace' => 'blog'], function () {
        //Transaction Report
        Route::get('/', [TransactionReportController::class, 'index'])->name('blogs');
        Route::get('create', [TransactionReportController::class, 'create'])->name('create');
        Route::post('store', [TransactionReportController::class, 'store'])->name('store');
        Route::get('delete/{id}', [TransactionReportController::class, 'delete'])->name('delete');
        Route::any('transaction/download', [TransactionReportController::class, 'download_transaction_report'])->name('transaction.download');
