...
<!-- Login Form -->
<div class="register-form dark-support" data-bg-img="{{asset('public/assets/admin-module')}}/img/media/login-bg.png">
    <div class="container">
                    ...
                    <div class="card my-5 ov-hidden">
                        <div class="register-wrap">
                            <div class="register-left">
                                <img class="login-img" src="{{asset('public/assets/admin-module')}}/img/media/login-img.jpg"
                                     alt="">
                            </div>
